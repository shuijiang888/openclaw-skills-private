...
# Roll back deployment to a known safe commit/tag for ZT007 scope.
# Usage:
#   scripts/rollback-zt.sh [target_ref]
# Example:
#   scripts/rollback-zt.sh d9a757b_hotfix_backup
